...
(function() {
    ...
    function buildFloatingPlayer() {
        ...
        container.innerHTML = `
            ...
            <style>
                ...
                #reloadBtn:hover, #minimizeBtn:hover, #closeBtn:hover {
                    background: rgba(255,255,255,0.15) !important;
                    color: #fff !important;
                    transform: scale(1.1);
                }
                #reloadBtn:active, #minimizeBtn:active, #closeBtn:active {
                    transform: scale(0.9);
                }
                .vjs-play-progress {
        ...
        container.addEventListener('wheel', function(e) {
            if (e.ctrlKey || e.metaKey) {
                ...
                currentScale = Math.min(2, Math.max(0.5, currentScale + delta));
        ...
        return {
            ...
            reloadBtn: container.querySelector('#reloadBtn'),
    ...
    function onDrag(e) {
        ...
        elements.container.style.transformOrigin = 'top left';
    }
    ...
    window.startAdvancedPlayer = async function() {
        ...
        const { videoContainer, reloadBtn, liveStatus } = elements;
